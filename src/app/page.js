...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* IEEE PES Content Section */}
      <section className="py-10 px-6 md:px-20 bg-gray-900 text-white">
      ...
      {/* Video Section */}
      <section className="py-10 px-6 md:px-20 bg-black text-white text-center">
